...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Animation scaleAnim = AnimationUtils.loadAnimation(getContext(),R.anim.scale);

        Button button1 = (Button) view.findViewById(R.id.button1Frag2);
